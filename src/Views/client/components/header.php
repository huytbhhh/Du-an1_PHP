                    ...
                    <ul>
                            ...
                            <ul class="mega-menu d-block">
                                <li class="d-flex">
                                    ...
                                    <ul class="d-flex align-items-center p-0 border-0 flex-column justify-content-center">
                                        <li>
                                            <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="/hmart/assets/images/banner/menu-banner.png" alt=""></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="dropdown position-static"><a href="#">Shop <i class="fa fa-angle-down"></i></a>
                            <ul class="mega-menu d-block">
                                <li class="d-flex">
                                    <ul class="d-block">
                                        <li class="title"><a href="#">DELL</a></li>
                                        <li><a href="shop-3-column.html">DELL1</a></li>
                                    ...
                                    <ul class="d-block">
                                        ...
                                        <li><a href="single-product.html">HP_1</a></li>
                                    ...
                                    <ul class="d-block">
                                        ...
                                        <li><a href="single-product-slider.html">Lenovo1</a></li>
                        ...
                        <li class="dropdown "><a href="#">Blog <i class="fa fa-angle-down"></i></a>
                            <ul class="sub-menu">
                                <li class="dropdown position-static"><a href="blog-grid-left-sidebar.html">Blog Grid</a>
                                </li>
                                <li class="dropdown position-static"><a href="blog-list-left-sidebar.html">Blog List</a>
                                </li>
                                <li class="dropdown position-static"><a href="blog-single-left-sidebar.html">Single Blog </a>
                                </li>
                            </ul>
                        </li>
