            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <?php
                        if(isset($_POST['checkout']) &&isset($_SESSION['cart']) &&isset($_SESSION['user_id'])){
                            ...
                            //
                            @mysqli_query($conn,"INSERT into orders(order_id,user_id,order_date,address,status,phone,total_amount)values($order_id,$user_id,NOW(),'$address','$status','$phone',$total)");
                            //insert detail
                            foreach($_SESSION['cart'] as $v){
                                $product_id=$v['id'];
                        ...
                        ?>
                        <form action="#" method="post" class="row" style="display:flex;justify-content:center">
