...
<body>
    <div class="main-wrapper">
        <<<<<<< HEAD <?php require_once 'components/header.php' ?>=======<?php require_once 'components/header.php' ?>>>>>>>> develop
                ...
                <div class="inner customScroll">
                    <div class="offcanvas-menu mb-4">
                        <ul>
                            ...
                            <<<<<<< HEAD <li><a href="/contact">Contact Us</a></li>
                                =======
                        ...
                        <div class="col-12">
                            <div class="about-wrapper text-center">
                                ...
                                <div class="promo-video">
                                    ...
                                    <<<<<<< HEAD <a href="https://youtu.be/7rmQIzbgpoA" class="venobox overlay-box" data-vbtype="video"><span class="fa fa-play"><i class="ripple"></i></span></a>
                                        =======
                            ...
                            <div class="team-wrapper ">
                                <div class="team-image overflow-hidden">
                                    ...
                                    <ul class="team-social d-flex">
                                        <li>
                                            <<<<<<< HEAD <a class="m-0" title="Twitter" target="_blank" rel="noopener noreferrer" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                                =======
